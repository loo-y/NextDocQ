...
const CareerSelection = () => {
    ...
    return (
        <div className="border-b-2 border-solid pb-4 mb-4 border-fuchsia-800">
                ...
                {({ open }) => (
                    <>
                        <div className="relative">
                            ...
                            <div className="relative inline-block ml-2 w-96">
                            ...
                            <div className="absolute right-0 top-1/2 -translate-y-2/4">
                                <SttMic />
                            </div>
                        </div>
                    </>
